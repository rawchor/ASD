...
//                new int[]{2,8,13,14,9,0,16,18,11,4}
                new int[]{6,1,11,17,10,9,19,3,7,4}
        );
        BTreePrinter.printNode(tree.root);

        //AVLTree tree1 = new AVLTree(new BSTTree(new int[]{6,1,11,17,10,9,19,3,7,4}).root); // from PREORDER
        AVLTree tree1 = new AVLTree(new BSTTree(new int[]{19,0,17,13,16,11,9,18,7,4}).root); // from PREORDER

        BTreePrinter.printNode(tree1.root);

        DelType delType = DelType.SUCC;
        int[] toDel = {11,3,18,6,12};
//
        ...
        BTreePrinter.printNode(tree1.root);
        tree1.insert(1);
        tree1.delete(toDel[1], delType);
        BTreePrinter.printNode(tree1.root);
        tree1.insert(9);
        tree1.delete(toDel[2], delType);
        BTreePrinter.printNode(tree1.root);
        tree1.delete(toDel[3], delType);
        BTreePrinter.printNode(tree1.root);
        tree1.insert(2);
        tree1.delete(toDel[4], delType);
        BTreePrinter.printNode(tree1.root);
